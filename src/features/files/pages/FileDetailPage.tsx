          ...
          {isFullscreen && (
            ...
            >
              ...
              <motion.div
                ...
                transition={{ delay: 0.1 }}
                className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-[var(--bg-primary)]/95 backdrop-blur-md border-b border-[var(--border-primary)]"
              >
              ...
              <div 
                ...
                className="absolute inset-0 pt-12 pb-0 overflow-y-auto scroll-smooth"
              >
